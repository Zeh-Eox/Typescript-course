...
let otherStrings: Array<string> = ['f', 'g', 'h', 'i', 'j'];

let numberAndString: (number | string)[] = [1, 'a', 2, 'b', 3, 'c'];
let otherNumberAndString: Array<number | string> = ['d', 4, 'e', 5, 'f'];

let booleanArray: boolean[] = [true, false, true, false, true];
let otherBooleanArray: Array<boolean> = [false, true, false, true, false];

let anyArray: any[] = [1, 'a', true, 2, 'b', false];
let otherAnyArray: Array<any> = ['c', 3, false, 'd', 4, true];



// On peut déclarer un tableau de tuples

let tupleArray: [number, string][] = [[1, 'a'], [2, 'b'], [3, 'c']];
let otherTupleArray: Array<[number, string]> = [[4, 'd'], [5, 'e'], [6, 'f']];
let mixedTupleArray: [number, string, boolean][] = [[1, 'a', true], [2, 'b', false], [3, 'c', true]];
let otherMixedTupleArray: Array<[number, string, boolean]> = [[4, 'd', false], [5, 'e', true], [6, 'f', false]];
...
let otherEmptyArray: Array<number> = [];
